...
namespace Senai.Carometro.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          (Microsoft.AspNetCore.Mvc.CompatibilityVersion.Version_2_1);
            ...
            {
                c.SwaggerDoc("v1", new Swashbuckle.AspNetCore.Swagger.Info { Title = "Swagger API Carometro", Version = "v1" });
            });
            ...
            {
                options.AddPolicy("CorsPolicy", builder => builder.AllowAnyOrigin().AllowAnyMethod().AllowCredentials());
            });
        }
